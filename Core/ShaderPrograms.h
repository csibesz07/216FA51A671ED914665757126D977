...
namespace cagd
{
    ...
    public:
        ...
        GLboolean SetUniformVariable1fv(const GLchar *name, GLsizei count, GLfloat *value);
        GLboolean SetUniformVariable1iv(const GLchar *name, GLsizei count, GLfloat *value);
